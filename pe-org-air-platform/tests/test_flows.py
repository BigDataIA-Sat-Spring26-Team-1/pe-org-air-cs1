...
class TestFullApplicationFlow:
    ...
    async def test_01_industries_list(self):
    ...
    async def test_02_company_lifecycle(self):
    ...
    async def test_03_assessment_lifecycle(self):
    ...
    async def test_04_dimension_scores_lifecycle(self):
        """Add -> List -> Update."""
        async with httpx.AsyncClient(base_url=BASE_URL) as client:
            # 1. Add Score
            payload = {
    ...
    async def test_05_error_handling_and_deletion(self):
